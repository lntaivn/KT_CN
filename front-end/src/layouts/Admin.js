    ...
    <div className="Admin flex h-[100vh]">
      ...
      <div className='Admin-Content flex-1 h-full overflow-auto p-5 px-7'>
        <Routes>
          ...
          <Route path="/postPrograms/createPrograms" element={<CreatePost collapsedNav={collapsedNav} setCollapsedNav={setCollapsedNav} TypeNews={"program"}/>} />
          ...
          <Route path="/postProgram/updateProgram/:id" element={<UpdatePost collapsedNav={collapsedNav} setCollapsedNav={setCollapsedNav} setSpinning={setSpinning} successNoti={successNoti} errorNoti={errorNoti} TypeNews={"program"}/>} />
