        ...
        <div className="Home">
            ...
            <div className="p-2 sm:px-5 md:p-10 lg:px-20 flex flex-col gap-10">
                ...
                <div className="News w-full flex flex-col">
                    <div className="flex p-4 justify-between items-center">
                        <p className="font-semibold text-[18px]">
                            <i className="fa-solid fa-newspaper mr-3 text-orange-500"></i>
                            {t("News.text_new_1")}
                        </p>
                        <Link to="/news" className="opacity-70 text-[16px]">
                            {t("News.text_new_2")}
                    ...
                    <div className="grid gap-2 w-full grid-cols-1 md:grid-cols-2">
                        {newsDataFitlered.length === 0 ? (
                            ...
                            newsDataFitlered.map((news) => (
                                <Link
                                    key={news.id_new}
                                    className="w-full flex gap-4 group/news p-4 hover:bg-gray-100"
                ...
                <div className="News w-full flex flex-col">
                    <div className="flex p-4 justify-between items-center">
                        <p className="font-semibold text-[18px]">
                            <i className="fa-solid fa-puzzle-piece mr-3 text-orange-500"></i>
                            {t("News.text_new_3")}
                        </p>
                        <Link to="/news" className="opacity-70 text-[16px]">
                            {t("News.text_new_2")}
                    ...
                    <div className="grid gap-2 w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ">
                        {newsDataFitlered.length === 0 ? (
                            ...
                            newsDataFitlered.map((news) => (
                                <Link
                                    key={news.id_new}
                                    className="w-full flex flex-col gap-3 group/news p-4 hover:bg-gray-100"
                                    to={`/news-detail/${news.id_new}`}
                                >
                                    <Image
                                        loading="lazy"
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex gap-20 m-auto">
                        ...
                        <div className="flex items-center justify-center">
                            <img
                                src="https://firebasestorage.googleapis.com/v0/b/ktcn-set-tvu.appspot.com/o/Hatk_Phuongnam.jpg?alt=media&token=217a6816-a83d-4a67-b102-018141c2f8d9"
                                width={125}
                                alt=""
                                className="object-cover"
                            />
                        ...
                        <div className="flex items-center justify-center">
                            <img
                                src="https://firebasestorage.googleapis.com/v0/b/ktcn-set-tvu.appspot.com/o/3iL3_ACI.jpg?alt=media&token=8b27198f-fe8c-4267-8623-697eeec60ce9"
                                width={150}
                                alt=""
                                className="object-cover"
                            />
                        ...
                        <div className="flex items-center justify-center">
                            <img
                                src="https://ktcn.tvu.edu.vn/ht96_image/lkweb/YPq9_Mylang.png"
                                width={150}
                                alt=""
                                className="object-cover"
                            />
